...
public class ImageUtils {
  ...
  private static final DisplayImageOptions.Builder DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER =
          new DisplayImageOptions.Builder().imageScaleType(ImageScaleType.IN_SAMPLE_POWER_OF_2)
                  ...
                  .showImageForEmptyUri(R.drawable.comic_background_placeholder)
                  .showImageOnLoading(R.drawable.comic_background_placeholder)
                  .showImageOnFail(R.drawable.comic_background_placeholder)
                  .cacheOnDisk(true)
                  .cacheInMemory(true)
                  .bitmapConfig(Config.ARGB_8888);
  private static final DisplayImageOptions DEFAULT_DISPLAY_IMAGE_OPTIONS =
          DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER.build();
  private static final DisplayImageOptions ROUND_DISPLAY_IMAGE_OPTIONS =
          DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER.displayer(new RoundedBitmapDisplayer(500)).build();
